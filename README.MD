...
[随机男声](source/audios/male-random-long.webm)

</td>
<td align="center">
    
[随机女声](source/audios/female-random-long.wav)
</td>
</tr>
</table>
...
[哪吒](source/audios/nezha-long.wav)

</td>
<td align="center">
    
[李靖](source/audios/lijing-long.wav)
...
[赞助商](source/audios/zanzhushang-long.wav)

</td>
<td align="center">
    
[殷夫人](source/audios/yinfuren-long.wav)
...
--engine vllm \  # vllm、sglang、torch、llama-cpp任选一个
--llm_device cuda \
...
--length_threshold 100 \  # 长文本阈值，超过这个长度启动长文本语音合成。
--window_size 100 \  # 长文本推理时，文本片段切分的窗口大小
--host 0.0.0.0 \ 
--port 8001
```

...
class BiCodecTokenizer:
    ...
    def __init__(
        ...
        Args:
            ...
            attn_implementation: What attention implementation to use.
        """
        self.device = device
        self.model_dir = model_dir
        self.config = load_config(f"{model_dir}/config.yaml")
        self._initialize_model(attn_implementation)

    def _initialize_model(self, attn_implementation: Optional[Literal["sdpa", "flash_attention_2", "eager"]] = None):
